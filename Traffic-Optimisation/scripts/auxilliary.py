...
sumoBinary = "/home/madtitan/sumo-1.0.1/sumo/bin/sumo"
parent_dir = os.path.dirname(os.path.dirname(__file__))
sumoConfig = os.path.join(parent_dir, "data/quickstart.sumo.cfg")

import traci


def makeDetectors(lanes):
    with open(os.path.join(parent_dir, 'data/quickstart.det.xml'), 'w') as f:
        f.write("<additional>\n")
        for lane in lanes:
